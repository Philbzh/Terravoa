...
export default function CheckoutError({
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center text-center px-6 bg-surface pt-28 pb-16">
      <span className="font-serif text-8xl text-outline-variant/20 mb-6 select-none">!</span>
      <h1 className="font-serif text-3xl text-primary mb-4">Checkout unavailable</h1>
      <p className="font-sans text-sm text-on-surface-variant max-w-md mb-10 leading-relaxed">
        Something went wrong while loading your checkout. Your cart is safe —
